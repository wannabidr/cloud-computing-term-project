...
/**
 * Validate that a path is within the OpenClaw workspace root and doesn't escape via `..`.
 * This is a security guard against path traversal attacks when using AaaS-provided workspace paths.
 */
